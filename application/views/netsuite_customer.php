...
<form action="<?php echo site_url() ?>/netsuite" method="GET">
      <div class="input-group input-group-sm">     
        <input type="text" style="width: 260px" class="form-control" name="term" placeholder="input company name">
          <div class="btn-group">
...
<td><?php echo number_format($baris->balance,0,',','.');?></td>
<td><?php echo number_format($baris->overdue_balance,0,',','.');?></td>
      </tr>
    <?php
      $no++;
      }

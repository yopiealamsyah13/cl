...
<div class="box box-primary">
        <form name="form-validate" id="engine" enctype="multipart/form-data" class="form-horizontal" method="post" action="<?php echo site_url(); ?>/customer_api/updateCLRequest/<?php echo $baris->id_customer;?>">
        <div class="box-body">

          <div class="form-group form-group-sm">
            <label for="id_customer" class="col-sm-2 control-label">Customer :</label>
              <div class="col-sm-4">
                <input type="hidden" value="<?php echo $baris->id_customer; ?>" name="id_customer">
          ...
          <div class="form-group form-group-sm">
            <label for="po_amount" class="col-sm-2 control-label">PO Amount :</label>
              <div class="col-sm-4">
                <input type="text" class="po_amount form-control" name="po_amount" value="<?php echo $baris->po_amount;?>" placeholder="Input Amount">
              </div>
          </div>
